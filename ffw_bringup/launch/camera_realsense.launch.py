...
local_parameters = [{'name': 'camera_name1', 'default': 'camera_left', 'description': 'camera1 unique name'},
                    ...
                    {'name': 'camera_namespace2', 'default': 'camera_right', 'description': 'camera2 namespace'},
                    {'name': 'serial_no1', 'default': serial1, 'description': 'choose device1 by serial number'},
                    {'name': 'serial_no2', 'default': serial2, 'description': 'choose device2 by serial number'},
                    {'name': 'depth_module.depth_profile1', 'default': '480,270,15', 'description': 'depth stream profile for camera1'},
                    {'name': 'depth_module.depth_profile2', 'default': '480,270,15', 'description': 'depth stream profile for camera2'},
                    {'name': 'depth_module.color_profile1', 'default': '424,240,15', 'description': 'Depth module color stream profile for d405 camera1'},
                    {'name': 'depth_module.color_profile2', 'default': '424,240,15', 'description': 'Depth module color stream profile for d405 camera2'},
                    ]
